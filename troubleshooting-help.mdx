...
<Steps>
  <Step title="Navigate to your workflow">
    Go to your workflow in the dashboard
  </Step>
  <Step title="Access logs">
    Click on the "Logs" or "History" tab
  </Step>
  <Step title="Review recent executions">
    Look for recent executions and their status
  </Step>
  <Step title="Examine failed executions">
    Click on failed executions to see detailed error messages
  </Step>
  <Step title="Check timestamps">
    Understand when failures occurred
  </Step>
  <Step title="Review execution details">
    Examine input data and step-by-step execution details
  </Step>
</Steps>

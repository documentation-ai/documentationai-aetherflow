...
<Columns cols="3">
  <Card title="Be Specific" icon="target" horizontal="false">
    Clearly define triggers, conditions, and actions. Avoid ambiguous language.
  </Card>

  <Card title="Use Context" icon="file-text" horizontal="false">
    Provide relevant background information and examples in your prompts.
  </Card>

  <Card title="Iterate Gradually" icon="refresh-cw" horizontal="false">
...
<Steps>
  <Step title="Implement Fallbacks" icon="shield" title-type="p">
    Define alternative actions when primary integrations fail.
  </Step>

  <Step title="Add Validation" icon="check-circle" title-type="p">
    Verify data integrity before processing or sending.
  </Step>

  <Step title="Monitor Success Rates" icon="bar-chart" title-type="p">
...
<ExpandableGroup>
  <Expandable title="Batch Processing" default-open="false">
  ...
  <Expandable title="Parallel Execution" default-open="false">
...
<Columns cols="2">
  ...
  <Card title="Access Control" icon="key" horizontal="false">
  ...
  <Card title="Regular Reviews" icon="eye" horizontal="false">
...
<Steps>
  <Step title="Set Up Alerts" icon="bell" title-type="p">
    Configure notifications for failures, performance degradation, and unusual patterns.
  </Step>

  <Step title="Regular Audits" icon="clipboard" title-type="p">
...
<ExpandableGroup>
  <Expandable title="Usage Monitoring" default-open="false">
    Track workflow execution frequency and identify optimization opportunities.
  </Expandable>

  <Expandable title="Resource Efficiency" default-open="false">
    Choose appropriate plan tiers based on actual usage patterns.
  </Expandable>

  <Expandable title="Automation ROI" default-open="false">

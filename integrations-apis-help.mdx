...
1. **Navigate to Integrations**: Go to the "Integrations" section in your dashboard
2. **Find your app**: Search for the service you want to connect
3. **Click "Connect"**: Initiate the OAuth authorization flow
4. **Grant permissions**: Review and approve the required access permissions
5. **Test connection**: Verify the integration is working properly
6. **Start using**: Begin building workflows with your connected service
